...
// 1. Submit Registration, Upload Player Documents & Create Database Rows
export async function submitRegistration(data: RegistrationInput) {
  ...
  // Upload files and create DB records for EVERY player in the array
  ...
  return reg; // Returns object containing reg.id for the payment page
}
