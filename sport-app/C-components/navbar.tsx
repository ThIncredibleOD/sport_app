     ...
     <nav className="bg-slate-900 text-slate-100 md:px-9 shadow-lg border-b border-slate-700">
      ...
      {/* Navigation Links */}
        <ul className="flex items-center gap-10 font-medium">
          <li>
            <Link href="/Homepage" className=" font-medium px-4 py-2 rounded-lg hover:bg-slate-100/10 hover:text-yellow-400 transition-colors duration-300">
              Home
            </Link>
          </li>
          <li>
            <Link href="/about" className="font-medium px-4 py-2 rounded-lg hover:bg-slate-100/10 transition-colors duration-300">
              About Us
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/competitions" className="text-green-500 font-medium px-4 py-2 rounded-lg hover:bg-slate-100/10 transition-colors duration-300">
              Competitions
            </Link>
          </li>
          <li>
