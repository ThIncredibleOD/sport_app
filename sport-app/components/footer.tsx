        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-0 items-start">
          ...
          <div className="flex flex-col gap-4 lg:pr-8">
            ...
            <div className="flex items-center gap-3 mt-2">
              {/* Facebook */}
              <Link href="#" aria-label="Facebook" className="flex items-center justify-center w-8 h-8 rounded-full border border-slate-700 hover:border-green-500 hover:text-green-500 transition-colors">
          ...
          <div className="lg:border-l lg:border-slate-700 lg:pl-10 flex flex-col gap-3 w-full">
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/Homepage" className="text-sm text-slate-300 hover:text-white transition-colors">Home</Link>
