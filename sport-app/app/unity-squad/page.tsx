...
export default function OfficialSquad() {
  ...
  const [squad] = useState([
    ...
    { id: 19, name: "Adewale Johnson", jerseyNo: "15", position: "Midfielder", dob: "31 Jun 2010", nationality: "Nigerian", avatar: "/players/p19.png" },
    { id: 20, name: "Oluwafemi Akinola", jerseyNo: "18", position: "Defender", dob: "31 Jun 2010", nationality: "Nigerian", avatar: "/players/p20.png" },
        ...
        <section className="space-y-2">
          {/* Header Bar */}
           <div className="flex items-center justify-between text-xs text-slate-400 px-1">
            <span>Total Players: <strong className="text-white">20</strong></span>
          </div>
